...
public class Level2 extends JFrame {
    ...
    public Level2() {
        setTitle("Mind Blow Game - Level 2");
        ...
        JLabel lblNewLabel = new JLabel("Level 2");
        ...
        progressLabel = new JLabel("Progress: 0/13 Diamonds");
        ...
        JPanel leftPanel = createStatsPanel("Diamonds", "22", statsDiamondIcon, new Color(0, 191, 255));
        leftPanel.setBounds(30, 150, 150, 250);
        contentPane.add(leftPanel);
        
        JPanel rightPanel = createStatsPanel("Bombs", "3", statsBombIcon, new Color(220, 50, 50));
        ...
        JLabel instructionLabel = new JLabel("Find 13 Diamonds to Win! Avoid the Bombs!");
    ...
    private void initializeGameGrid(JPanel gamePanel, Font buttonFont, Color buttonForeground, 
        ...
        // Set 3 bombs (Level 2 has 3 bombs)
        for (int i = 0; i < 3; i++) {
                ...
                buttons[row][col].addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (isBomb[r][c]) {
                            ...
                            numOClicked++;
                            progressLabel.setText("Progress: " + numOClicked + "/13 Diamonds");
                            checkWinCondition();
                        }
                    }
                });
    ...
    private void showGameOverDialog() {
        ...
        JOptionPane.showMessageDialog(null, "Your Highest Level: 2");

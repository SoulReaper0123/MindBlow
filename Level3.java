...
public class Level3 extends JFrame {
    ...
    public Level3() {
        setTitle("Mind Blow Game - Level 3");
        ...
        progressLabel = new JLabel("Progress: 0/10 Diamonds");
        ...
        JPanel leftPanel = createStatsPanel("Diamonds", "21", statsDiamondIcon, new Color(0, 191, 255));
        leftPanel.setBounds(30, 150, 150, 250);
        contentPane.add(leftPanel);
        
        JPanel rightPanel = createStatsPanel("Bombs", "4", statsBombIcon, new Color(220, 50, 50));
        ...
        JLabel instructionLabel = new JLabel("Find 10 Diamonds to Win! Avoid the Bombs!");
    ...
    private void initializeGameGrid(JPanel gamePanel, Font buttonFont, Color buttonForeground, 
        ...
        // Set 4 bombs (Level 3 has 4 bombs)
        for (int i = 0; i < 4; i++) {
                ...
                buttons[row][col].addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (isBomb[r][c]) {
                            ...
                            numOClicked++;
                            progressLabel.setText("Progress: " + numOClicked + "/10 Diamonds");
                            checkWinCondition();
                        }
                    }
                });
    ...
    private void checkWinCondition() {
        if (numOClicked == totalOButtons) {
            ...
            int choice = JOptionPane.showConfirmDialog(null, "You've completed all levels! Return to home?", "Level Complete", JOptionPane.YES_NO_OPTION);
            if (choice == JOptionPane.YES_OPTION) {
                home level = new home();
                level.setVisible(true);
                dispose();
    ...
    private void showGameOverDialog() {
        ...
        JOptionPane.showMessageDialog(null, "Your Highest Level: 3");
